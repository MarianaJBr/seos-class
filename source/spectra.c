...
int spectra_pk_at_z(
  ...
  /* JL 21.09.2017: TODO: now, P(k) total is already calculated and
     ...
     that here too to compute output_tot, instead of redoing the sum
     over ICs. */
  ...
  /** - --> (a) linear mode: if only one initial condition, convert output_tot to linear format;
   * if several initial conditions, convert output_ic to linear format,
   * output_tot is already in this format */
