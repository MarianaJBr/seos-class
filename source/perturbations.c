...
/**
 * mjb:seos. add column to store delta_fld and theta_fld
 * **/
  ...
  if (_scalars_) {
    ...
    */
    ...
    if ((ppt->has_ad == _TRUE_) && (index_ic == ppt->index_ic_ad)) {
      ...
      /* mjb TODO adapt these eqns to a more general case like SEoS*/
  ...
  if (_scalars_) {
    ...
    if (pba->has_fld == _TRUE_) {
      ...
      if (pba->use_ppf == _FALSE_){
        ...
        /** - ----> fluid density */
        /*mjb: to check eqn 8 and 9 arXiv:0703202*/
