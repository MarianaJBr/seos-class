...
#CCFLAG = -g -fPIC -I/Users/mjbr/codes/gsl-2.1/gslbuilds/include/ -L/Users/mjbr/codes/gsl-2.1/gslbuilds/lib/ -lgsl -lgslcblas
#CCFLAG = -g -fPIC -I/Users/mariannejbr/codes/gsl-2.4/gslbuilds/include/ -L/Users/mariannejbr/codes/gsl-2.4/gslbuilds/lib/ -lgsl -lgslcblas
CCFLAG = -g -fPIC -I/Users/mariannejbr/codes/gsl-2.4/gslbuilds/include/ -L/Users/mariannejbr/codes/gsl-2.4/gslbuilds/lib/ -lgsl -lgslc
#CCFLAG = -g -fPIC
LDFLAG = -g -fPIC
...
class: $(TOOLS) $(SOURCE) $(EXTERNAL) $(OUTPUT) $(CLASS)
	$(CC) -L/Users/mariannejbr/codes/gsl-2.4/gslbuilds/lib/ -lgsl -lgslcblas $(OPTFLAG) $(OMPFLAG) $(LDFLAG) -o class $(addprefix build/,$(notdir $^)) -lm -lgsl -lgslcblas
...
classy: libclass.a python/classy.pyx python/cclassy.pxd
	cd python; export CC=$(CC); $(PYTHON) setup.py install --force $(PYTHONFLAGS)
